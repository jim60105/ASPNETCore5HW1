...
namespace ASPNETCore5HW1.Migrations
{
    ...
    [Migration("20201212142708_addIsDeleted")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnType("int")
                        .HasColumnName("InstructorID");
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.VwCourseStudent", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.VwCourseStudentCount", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.VwDepartmentCourseCount", b =>
                {
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.Course", b =>
                {
                    b.HasOne("ASPNETCore5HW1.Models.Department", "Department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.CourseInstructor", b =>
                {
                    b.HasOne("ASPNETCore5HW1.Models.Course", "Course")
                    ...
                    b.HasOne("ASPNETCore5HW1.Models.Person", "Instructor")
                        .WithMany("CourseInstructors")
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("ASPNETCore5HW1.Models.Person", "Student")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("ASPNETCore5HW1.Models.OfficeAssignment", b =>
                {
                    b.HasOne("ASPNETCore5HW1.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("ASPNETCore5HW1.Models.OfficeAssignment", "InstructorId")
